...
class QuDev_transmon(Qubit):
    ...
    def __init__(self, name, **kw):
        ...
        self.add_pulse_parameter(op_name, ps_name + '_truncation_length',
                                 'truncation_length',
                                 initial_value=None)
        self.add_pulse_parameter(op_name, ps_name + '_truncation_decay_length',
                                 'truncation_decay_length',
                                 initial_value=None)
        self.add_pulse_parameter(op_name, ps_name + '_truncation_decay_sigma',
