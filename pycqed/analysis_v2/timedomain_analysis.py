...
class FluxPulseTimingBetweenQubitsAnalysis(MultiQubit_TimeDomain_Analysis):
    ...
    def process_data(self):
        ...
        for qbn in self.qb_names:
            ...
            self.proc_data_dict['analysis_params_dict'][qbn]['delay_stderr'] = np.diff(delays).mean()
            self.proc_data_dict['analysis_params_dict'][qbn]['corr_data'] = np.array(corr_data)
        self.save_processed_data(key='analysis_params_dict')
    ...
    def prepare_plots(self):
        ...
        for qbn in self.qb_names:
            ...
            corr_data = self.proc_data_dict['analysis_params_dict'][qbn]['corr_data']
            ...
            self.plot_dicts['corr_vline_' + qbn] = {
                ...
                'x': self.proc_data_dict['analysis_params_dict'][qbn]['delay'] / 1e-9,
                'ymin': corr_data.min(),
                'ymax': corr_data.max(),
                'colors': 'gray'}
